  ...
  <div class="main">
    ...
    <div class="main_box">
      ...
      <pdf
        ...
        style="width:1270px;height:712px;margin:60px auto 20px auto;"
      >
      </pdf>
      <div id="page">
        <img
        ...
        >
        <span class="arrow">{{currentPage}} / {{pageCount}}</span>
        <img
...
export default {
  ...
  watch: {
    ...
    'ppt_path': function (val) {
      var that = this;
      this.$nextTick(function () {
        that.pdfSrc = pdf.createLoadingTask(val);
        this.websocketPdf(val)
      });
    },
  },
};
